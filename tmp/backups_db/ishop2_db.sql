...
-- Дамп структуры для таблица ishop2.attribute_group
...
-- Дамп данных таблицы ishop2.attribute_group: ~5 rows (приблизительно)
...
-- Дамп структуры для таблица ishop2.attribute_product
...
-- Дамп данных таблицы ishop2.attribute_product: ~47 rows (приблизительно)
DELETE FROM `attribute_product`;
...
-- Дамп структуры для таблица ishop2.attribute_value
...
-- Дамп данных таблицы ishop2.attribute_value: ~19 rows (приблизительно)
...
-- Дамп структуры для таблица ishop2.brand
...
-- Дамп данных таблицы ishop2.brand: ~5 rows (приблизительно)
DELETE FROM `brand`;
/*!40000 ALTER TABLE `brand` DISABLE KEYS */;
INSERT INTO `brand` (`id`, `title`, `alias`, `img`, `description`) VALUES
	(1, 'Casio', 'casio', 'abt-1.jpg', 'тщательно продумывает будущее наручных часов.'),
	(2, 'Citizen', 'citizen', 'abt-2.jpg', 'является крупнейшим мировым производителем часов.'),
	(3, 'Royal London', 'royal-london', 'abt-3.jpg', 'молодой часовой бренд родом из Великобритании.'),
	(4, 'Seiko', 'seiko', 'seiko.png', NULL),
	(5, 'Diesel', 'diesel', 'diesel.png', NULL);
/*!40000 ALTER TABLE `brand` ENABLE KEYS */;


-- Дамп структуры для таблица ishop2.category
...
-- Дамп данных таблицы ishop2.category: ~14 rows (приблизительно)
...
-- Дамп структуры для таблица ishop2.currency
...
-- Дамп данных таблицы ishop2.currency: ~3 rows (приблизительно)
...
-- Дамп структуры для таблица ishop2.gallery
...
-- Дамп данных таблицы ishop2.gallery: ~3 rows (приблизительно)
DELETE FROM `gallery`;
...
-- Дамп структуры для таблица ishop2.modification
...
-- Дамп данных таблицы ishop2.modification: ~6 rows (приблизительно)
...
-- Дамп структуры для таблица ishop2.order
...
-- Дамп данных таблицы ishop2.order: ~0 rows (приблизительно)
DELETE FROM `order`;
/*!40000 ALTER TABLE `order` DISABLE KEYS */;
/*!40000 ALTER TABLE `order` ENABLE KEYS */;


-- Дамп структуры для таблица ishop2.order_product
...
-- Дамп данных таблицы ishop2.order_product: ~0 rows (приблизительно)
DELETE FROM `order_product`;
/*!40000 ALTER TABLE `order_product` DISABLE KEYS */;
/*!40000 ALTER TABLE `order_product` ENABLE KEYS */;


-- Дамп структуры для таблица ishop2.product
...
-- Дамп данных таблицы ishop2.product: ~31 rows (приблизительно)
DELETE FROM `product`;
/*!40000 ALTER TABLE `product` DISABLE KEYS */;
INSERT INTO `product` (`id`, `category_id`, `brand_id`, `title`, `alias`, `content`, `price`, `old_price`, `publish`, `keywords`, `description`, `img`, `hit`) VALUES
	...
	(9, 6, 4, 'Royal London 20034-02', 'royal-london-20034-02', NULL, 110, 0, '1', NULL, NULL, 'no_image.jpg', '1'),
...
-- Дамп структуры для таблица ishop2.related_product
...
-- Дамп данных таблицы ishop2.related_product: ~7 rows (приблизительно)
...
-- Дамп структуры для таблица ishop2.user
...
-- Дамп данных таблицы ishop2.user: ~0 rows (приблизительно)
DELETE FROM `user`;
