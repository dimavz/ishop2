...
<head>
    ...
    <link rel="stylesheet" href="<?php echo PATH.'/public/errors/css/style.css'?>">
...
<div class="main w3l">
    ...
    <h1> ОШИБКА 404</h1>
    <h3>"Приносим извинения! Данная страница не найдена"</h3>
    <a href="<?php echo PATH ?>" class="back">Перейти на главную</a>
    ...
    <div class="footer agileits">
        <p>Копирайт © 2018 Страница ошибки. Все права защищены | Разработка <a href="http://w3layouts.com" target="_blank">W3layouts</a></p>
    </div>
</div>
