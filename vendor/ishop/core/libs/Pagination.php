...
class Pagination{
    ...
    public function getHtml(){
        ...
        if( $this->currentPage < $this->countPages ){
            $next = "<li><a class='nav-link' href='{$this->uri}page=" .($this->currentPage + 1). "'>&gt;</a></li>";
        }
        ...
        return '<ul class="pagination">' . $startpage.$back.$page2left.$page1left.'<li class="active"><a>'.$this->currentPage.'</a></li>'.$page1right.$page2right.$next.$endpage . '</ul>';
    }
